...
@objc protocol CallViewControllerDelegate {
    @objc func callViewControllerWantsToBeDismissed(_ viewController: BaitshookCallViewController)
    @objc func callViewControllerWantsVideoCallUpgrade(_ viewController: BaitshookCallViewController)
    @objc func callViewControllerDidFinish(_ viewController: BaitshookCallViewController)
    @objc func callViewController(_ viewController: BaitshookCallViewController, wantsToSwitchFromRoom from: String, toRoom to: String)
}
...
@objcMembers
class BaitshookCallViewController: UIViewController,
    ...
    func callController(_ callController: NCCallController!, didCreateCameraController cameraController: BaitshookCameraController!) {
        DispatchQueue.main.async {
    ...
    func addReaction(_ reaction: String, fromUser user: String) {
        let callReactionView = BaitshookCallReactionView(frame: .zero)
    ...
    func showReaction(_ callReactionView: BaitshookCallReactionView) {
