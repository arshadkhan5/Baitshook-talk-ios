...
@class RTCAudioTrack;
@class RTCVideoTrack;
@class BaitshookCameraController;
@class TalkActor;
...
- (void)callController:(NCCallController *)callController didCreateCameraController:(BaitshookCameraController *)cameraController;
