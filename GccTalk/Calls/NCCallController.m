...
@property (nonatomic, strong) BaitshookCameraController *cameraController;
...
- (void)createLocalVideoTrack
{
    ...
    self.cameraController = [[BaitshookCameraController alloc] initWithVideoSource:videoSource videoCapturer:videoCapturer];
