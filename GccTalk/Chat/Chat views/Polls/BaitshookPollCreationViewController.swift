...
@objcMembers class BaitshookPollCreationViewController: UITableViewController, UITextFieldDelegate, PollDraftsViewControllerDelegate {
    ...
    let footerView = BaitshookPollFooterView(frame: CGRect.zero)
    ...
    func presentPollDraftsView() {
        let pollDraftsVC = BaitshookPollDraftsViewController(room: room)
    ...
    func configureFooterButtons() {
        ...
        footerView.frame = CGRect(x: 0, y: 0, width: 0, height: BaitshookPollFooterView.heightForOption)
        ...
        if draftsAvailable, editingDraftId == nil {
            ...
            footerView.frame.size.height += BaitshookPollFooterView.heightForOption
