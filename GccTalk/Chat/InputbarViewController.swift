...
@objcMembers public class InputbarViewController: SLKTextViewController, NCChatTitleViewDelegate {
    ...
    public override func viewDidLoad() {
        ...
        self.autoCompletionView.register(BaitshookAutoCompletionTableViewCell.self, forCellReuseIdentifier: BaitshookAutoCompletionTableViewCell.identifier)
    ...
    public override func heightForAutoCompletionView() -> CGFloat {
        return BaitshookAutoCompletionTableViewCell.cellHeight * CGFloat(self.autocompletionUsers.count) + (self.autoCompletionView.tableHeaderView?.frame.height ?? 0)
    }
    ...
    public override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard tableView == self.autoCompletionView,
              ...
              let cell = self.autoCompletionView.dequeueReusableCell(withIdentifier: BaitshookAutoCompletionTableViewCell.identifier) as? BaitshookAutoCompletionTableViewCell
        else {
            return BaitshookAutoCompletionTableViewCell(style: .default, reuseIdentifier: BaitshookAutoCompletionTableViewCell.identifier)
        }
        ...
        cell.accessibilityIdentifier = BaitshookAutoCompletionTableViewCell.identifier
        return cell
    }
    ...
    public override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return BaitshookAutoCompletionTableViewCell.cellHeight
    }
