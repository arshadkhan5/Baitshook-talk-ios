...
- (void)setupNCCommunicationForAccount:(TalkAccount *)account
{
    ...
    NSString *userAgent = [NSString stringWithFormat:@"Mozilla/5.0 (iOS) GCC-Talk v%@", [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"]];
...
- (void)initImageDownloaders
{
    ...
    NSString *userAgent = [NSString stringWithFormat:@"Mozilla/5.0 (iOS) GCC-Talk v%@",
