...
NSString * const talkAppName = @"GCC Talk";
NSString * const filesAppName = @"GCC Cloud";
NSString * const copyright = @"© 2026 Baitshook";
NSString * const bundleIdentifier = @"com.gcc.Talk";
NSString * const groupIdentifier = @"group.com.gcc.Talk";
...
NSString * const brandColorHex = @"#F5F5F5";
NSString * const brandTextColorHex = @"#0B2A3A";
...
+ (UIImage *)navigationLogoImage
{
    if (@available(iOS 26.0, *)) {
        if (!customNavigationLogo) {
            return [[UIImage imageNamed:@"gcc_talk"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        }
    }

    NSString *imageName = @"gcc_talk";
    if (!customNavigationLogo) {
...
+ (UIColor *)avatarPlaceholderColor
{
    ...
    UIColor *dark = [NCUtils colorFromHexString:@"#dbdbdb"];
