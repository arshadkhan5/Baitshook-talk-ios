...
//    [joinVideoButton setValue:[UIImage systemImageNamed:@"video"] forKey:@"image"];
    [joinAudioButton setValue:[[UIImage imageNamed:@"call_icon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]
                       forKey:@"image"];

    [joinVideoButton setValue:[[UIImage imageNamed:@"video"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]
                       forKey:@"image"];
...
- (void)presentCallViewController:(BaitshookCallViewController *)callViewController withCompletionBlock:(PresentCallControllerCompletionBlock)block
{
    [_mainViewController dismissViewControllerAnimated:NO completion:nil];
